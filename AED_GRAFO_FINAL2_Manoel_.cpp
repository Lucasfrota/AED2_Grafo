...
class Vertice{
	private:
		...
		int d;
		int f;
		int cont;			//tamanho da lista de adjacencias e distancias
...
class Lista{
	...
	public:
		...
		T* getVerticeDe(int num){ //num é um valor a ser encontrado na lista
		...
		T* getVerticeEm(int position){ //posiçao no vetor a ser encontrada
